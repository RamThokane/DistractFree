    ...
    <div className="min-h-screen flex bg-[#0F1115] text-white selection:bg-indigo-500/30 font-sans">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden items-center justify-center bg-[#05050A] border-l border-white/[0.04]">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
           {/* Glows */}
           <div className="absolute bottom-[-20%] left-[-10%] w-[70%] h-[70%] rounded-full opacity-[0.08] blur-[100px]" style={{background:'radial-gradient(circle, #6366F1, transparent 70%)'}} />
           <div className="absolute top-[-20%] right-[-10%] w-[70%] h-[70%] rounded-full opacity-[0.06] blur-[120px]" style={{background:'radial-gradient(circle, #8B5CF6, transparent 70%)'}} />
           <div className="absolute bottom-[40%] right-[30%] w-[40%] h-[40%] rounded-full opacity-[0.04] blur-[80px]" style={{background:'radial-gradient(circle, #3FAE6A, transparent 70%)'}} />
        ...
        <div className="relative z-10 w-full max-w-[640px] h-[640px] flex items-center justify-center">
          ...
          <motion.div 
            className="absolute z-30 bottom-[5%] right-[2%] w-64 rounded-2xl bg-[#1A1D24]/95 backdrop-blur-2xl border border-white/[0.1] p-3.5 shadow-[0_20px_40px_rgba(0,0,0,0.5)] scale-[0.85]"
